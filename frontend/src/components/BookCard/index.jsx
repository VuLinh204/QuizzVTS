        ...
        <div className={cx('topic-card-item')}>
            ...
            <div className={cx("details")}>
                ...
                <div>
                    ...
                    <span className={cx("overflow")}>Bruce Edward Bursten, Catherine J. Murphy, H. Eugene Lemay, Matthew E. Stoltzfus, Patrick Woodward, Theodore E. Brown</span>
                </div>
                <div>
                    <span className={cx("verified-messaging")}>
                        <span className={cx('icon')}><i class="fa-solid fa-circle-check"></i></span>
